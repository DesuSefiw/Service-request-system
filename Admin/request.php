...
<div class="col-sm-4 mb-5">
 ...
 $sql = "SELECT request_id, request_info, request_desc,staff, request_date FROM submitrequest_tb WHERE 	requester_city='".$staff."' ";
 ...
 if($result->num_rows > 0){
   ...
   echo '<h5 class="card-title1">TO(Department) : ' . $row['staff'] . '</h5>';
   echo '<h5 class="card-title">Request Info : ' . $row['request_info'] . '</h5>';
   echo '<p class="card-text">Describtion:' . $row['request_desc'] . '</p>';
