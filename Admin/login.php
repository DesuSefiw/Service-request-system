...
if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
    ...
    $aPassword = mysqli_real_escape_string($conn,trim($_REQUEST['aPassword']));
	    $staff = mysqli_real_escape_string($conn,trim($_REQUEST['staff']));
    $sql = "SELECT a_email, a_password FROM adminlogin_tb WHERE a_email='".$aEmail."' AND a_password='".$aPassword."'AND staff='".$staff."' limit 1";
...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>Admin(Director of requester)
      </span>
  </p>
    ...
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
		  ...
		  <div class="form-group">
            <i class="fas fa-user"></i><label for="staff" class="pl-2 font-weight-bold">Department</label>
      <select name='staff' class="form-control" size="2">
