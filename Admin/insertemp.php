...
if(isset($_REQUEST['empsubmit'])){
 ...
 if(($_REQUEST['empName'] == "") || ($_REQUEST['email'] == "") || ($_REQUEST['password'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $sql = "INSERT INTO technicianlogin (name, email, password,staff) VALUES ('$eName', '$ema','$pass','".$staff."')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
	...
	<div class="form-group">
	 ...
	 <input type="text" class="form-control" id="tstaff" value=" <?php echo $staff ?>" readonly>
    </div>
