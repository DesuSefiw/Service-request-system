...
<body>
 <!-- Top Navbar -->
 <img src='images/A.png' width='25'/>
 <nav style=background-color:gray class="navbar navbar-dark fixed-top flex-md-nowrap p-0 ">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">IES</a>
 </nav>
    ...
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
	   ...
	   <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'veiw') { echo 'active'; } ?>" href="view.php">
        <i class="fas fa-align-center"></i>
          Director accepts?
       </a>
      </li>
